...
public class RestClient implements CommandLineRunner {
   private static final Logger log = Logger
         .getLogger(RestClient.class.toString());
   ...
   private void getOneGreeting(RestTemplate restTemplate) {
   ...
   private void deleteGreeting(RestTemplate restTemplate) {
      // We want to delete Greeting at index=2
      restTemplate.delete("http://localhost:8080/greeting/2");
      
   }

   private void putGreeting(RestTemplate restTemplate) {
   ...
   private void postGreeting(RestTemplate restTemplate) {
   ...
   private void getAndShowGreetings(RestTemplate restTemplate) {
