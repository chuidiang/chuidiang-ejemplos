...
public class AnStructDataWriterImpl extends org.opensplice.dds.dcps.DataWriterImpl implements AnStructDataWriter
{
    private long copyCache;
    private AnStructTypeSupport typeSupport;

    public AnStructDataWriterImpl(First.AnStructTypeSupport ts)
    {
        typeSupport = ts;
