...
public class AnStructDataReaderViewImpl extends org.opensplice.dds.dcps.FooDataReaderViewImpl implements AnStructDataReaderView
{
    private long copyCache;
    private AnStructTypeSupport typeSupport;

    public AnStructDataReaderViewImpl(First.AnStructTypeSupport ts)
    {
        typeSupport = ts;
